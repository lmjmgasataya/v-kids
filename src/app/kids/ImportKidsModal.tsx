...
import { buildKidImportTemplate } from "@/lib/csv";
import { importKidsCsv, type ImportSummary } from "./actions";

export function ImportKidsModal() {
  ...
  function handleDownloadTemplate() {
    const blob = new Blob([buildKidImportTemplate()], { type: "text/csv;charset=utf-8;" });
  ...
  async function handleImport() {
    ...
    try {
      ...
      const summary = await importKidsCsv(text);
      setResult(summary);
          ...
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            ...
            {result && (
              <div className="mt-4 rounded-lg bg-gray-50 p-3 text-sm">
                <p className="font-semibold text-kids-green">{result.imported} kid(s) imported.</p>
